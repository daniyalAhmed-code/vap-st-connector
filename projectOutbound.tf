module "api_project_outbound" {
  source = "./vendor/modules/api"
  # stage_name   = var.env
  stage_name = "beta"
  #name         = "${var.name}-${var.env}-device-type"
  name           = "ProjectOutbound"
  description    = "API for Project Outbound Resource"
  swagger_file   = "./templates/swagger-ProjectOutbound-1.0.0.yaml"
